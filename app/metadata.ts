...
export const metadata: Metadata = {
  ...
  keywords: 'avukat, hukuk bürosu, istanbul, aile hukuku, iş hukuku, idare hukuku, bilişim hukuku, yabancılar hukuku',
  authors: [{ name: 'Av. Erencan Gülkan' }],
  creator: 'Av. Erencan Gülkan',
  publisher: 'Av. Erencan Gülkan',
  robots: 'index, follow',
